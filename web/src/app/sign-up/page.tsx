      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-8 sm:p-16 md:p-24 overflow-y-auto max-h-screen">
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <form className="space-y-6" onSubmit={(e) => {
            ...
            <button type="submit" className="w-full bg-gradient-to-br from-primary to-primary-container text-white py-4 rounded-xl font-black text-lg hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-primary/20 mt-4">
              Create Account
            </button>
          </form>

          <p className="mt-8 text-center text-secondary font-medium">
            Already a member? <Link href="/sign-in" className="text-primary hover:underline">Sign In</Link>
          </p>
        </div>
      </div>
