              ...
              <AnimatePresence mode="popLayout">
                {paginatedCars.map((car) => (
                  ...
                  >
                    ...
                    <Link href={`/checkout?car=${car.id}`} className="mt-auto w-full min-h-[48px] bg-surface-container-highest hover:bg-gradient-to-br hover:from-primary hover:to-primary-container text-on-surface hover:text-white font-bold rounded-xl flex items-center justify-center gap-2 transition-all group-hover:shadow-lg group-hover:shadow-primary/20">
                      Book Now
